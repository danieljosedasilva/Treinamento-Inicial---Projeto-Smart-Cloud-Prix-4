...
apiappname=PrintFramerAPI$(openssl rand -hex 7)
...
printf "%s %s %s\n\n" "DEPLOYMENT-PASSWORD for " "$GIT_URL:" "$DEPLOY_PASSWORD"

printf "API-ROOT-URL: https://$apiappname.azurewebsites.net\n\n"

printf "EXAMPLE-URL: https://$apiappname.azurewebsites.net/api/priceframe/6/17\n\n"
